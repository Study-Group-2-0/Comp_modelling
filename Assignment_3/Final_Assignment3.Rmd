...
m2_meta_priors <- c(
  ...
  prior(exponential(1), class = sigma),
  prior(normal(0, 0.8), class = sd, group = Intercept, coef = Language:ID),
  prior(exponential(1), class = sd, coef = Language:ID),
  prior(normal(0.35, 0.1), class = sd, group = Intercept, coef = Language),
  prior(exponential(1), class = sd, coef = Language)
)
